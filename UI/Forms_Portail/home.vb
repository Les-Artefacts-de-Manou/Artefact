...
#Region "Navigation: Référentiels"
    ...
    '------------------------------------------------------------ 
    'Private Sub btnOpenGestionLangues_Click(sender As Object, e As EventArgs)

    '    Try
    '        ShowFormIfNotOpen(Of GestionLangues)()
    '        EcrireLog("📖 [Form] Formulaire GestionLangues affiché.", LogLevel.Rapide, LogCategory.UI)
    '    Catch ex As Exception
    '        EcrireLog("UI: erreur Load GestionLangues.", LogLevel.Succinct, LogCategory.UI, ex)
    '    End Try

    'End Sub

    'Private Sub btnOpenGestionPays_Click(sender As Object, e As EventArgs)

    '    Try
    '        ShowFormIfNotOpen(Of GestionPays)()
    '        EcrireLog("📖 [Form] Formulaire GestionPays affiché.", LogLevel.Rapide, LogCategory.UI)
    '    Catch ex As Exception
    '        EcrireLog("UI: erreur Load GestionPays.", LogLevel.Succinct, LogCategory.UI, ex)
    '    End Try
    'End Sub

    'Private Sub btnOpenGestionRefEnum_Click(sender As Object, e As EventArgs)

    '    Try
    '        ShowFormIfNotOpen(Of GestionRefEnum)()
    '        EcrireLog("📖 [Form] Formulaire GestionRefEnum affiché.", LogLevel.Rapide, LogCategory.UI)
    '    Catch ex As Exception
    '        EcrireLog("UI: erreur Load GestionRefEnum.", LogLevel.Succinct, LogCategory.UI, ex)
    '    End Try

    'End Sub

    'Private Sub btnOpenGestionContactsClick(sender As Object, e As EventArgs)

    '    Try
    '        ShowFormIfNotOpen(Of GestionContacts)()
    '        EcrireLog("📖 [Form] Formulaire GestionContacts affiché.", LogLevel.Rapide, LogCategory.UI)
    '    Catch ex As Exception
    '        EcrireLog("UI: erreur Load GestionContacts.", LogLevel.Succinct, LogCategory.UI, ex)
    '    End Try

    'End Sub

    'Private Sub btnOpenGestionEditeurs_Click(sender As Object, e As EventArgs)

    '    Try
    '        ShowFormIfNotOpen(Of GestionEditeurs)()
    '        EcrireLog("📖 [Form] Formulaire GestionEditeurs affiché", LogLevel.Rapide, LogCategory.UI)
    '    Catch ex As Exception
    '        EcrireLog("UI: erreur Load GestionEditeurs.", LogLevel.Succinct, LogCategory.UI, ex)
    '    End Try

    'End Sub

    'Private Sub btnOpenGestionFormatFile_Click(sender As Object, e As EventArgs)

    '    Try
    '        ShowFormIfNotOpen(Of GestionFormatFile)()
    '        EcrireLog("📖 [Form] Formulaire GestionFormatFile affiché", LogLevel.Rapide, LogCategory.UI)
    '    Catch ex As Exception
    '        EcrireLog("UI: erreur Load GestionFormatFile.", LogLevel.Succinct, LogCategory.UI, ex)
    '    End Try
    ...
    '=============================================================================
    ' Ces boutons appelaient les anciennes Forms GestionXXX qui ont été remplacées
    ' par les UserControls (UC_Impression, UC_Recommandations, UC_PrixLit) dans
    ' le PortailReferentiels.
    '
    ' Pour accéder à ces fonctionnalités, utiliser maintenant :
    ' → btnOpenPortailReferentiels → Puis naviguer dans le portail UC
    '=============================================================================
    ...
    '------------------------------------------------------------
    ' 📌 V1.0 - 23/03/2026
    ' btnOpenPortailReferentiels_Click
    '
    ' Ouvre le nouveau PortailReferentiels (UserControls)
    ' TEMPORAIRE - pour tests migration Forms → UC
    '------------------------------------------------------------

    Private Sub btnOpenPortailReferentiels_Click_1(sender As Object, e As EventArgs) Handles btnOpenPortailReferentiels.Click

        Try
            ShowFormIfNotOpen(Of PortailReferentiels)()
            EcrireLog("📖 [Form] PortailReferentiels (UserControls) affiché", LogLevel.Rapide, LogCategory.UI)
        Catch ex As Exception
            EcrireLog("UI: erreur Load PortailReferentiels.", LogLevel.Succinct, LogCategory.UI, ex)
            MessageBox.Show(
                "Erreur lors de l'ouverture du Portail Référentiels." & Environment.NewLine & ex.Message,
                "Artefact",
                MessageBoxButtons.OK,
                MessageBoxIcon.Error
            )
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ShowFormIfNotOpen(Of GestionConnexionMariaDb)()
    End Sub
