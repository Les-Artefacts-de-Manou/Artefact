...
### Impression
La première impression qu'on retire d'un livre, souvent basée sur la couverture, le titre, le résumé, etc. C'est une perception initiale qui peut être influencée par des éléments visuels et textuels.
